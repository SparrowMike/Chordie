...
import { chordieAtom, chordsAtom, guitarNotesAtom, preferencesAtom, scalesAtom } from './../controller/atoms';

import { deepCopy, extractRelativeNotes, updateChordTones } from '../utils/utils';
